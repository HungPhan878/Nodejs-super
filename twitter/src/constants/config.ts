...
export const envConfig = {
  ...
  passwordSecret: process.env.KEY_SECRET_PW as string,
  jwtSecretAccessToken: process.env.JWT_ACCESS_TOKEN_SECRET as string,
  jwtSecretRefreshToken: process.env.JWT_REFRESH_TOKEN_SECRET as string,
  jwtSecretEmailVerifyToken: process.env.JWT_EMAIL_VERIFY_TOKEN_SECRET as string,
  jwtSecretForgotPasswordToken: process.env.JWT_FORGOT_PASSWORD_TOKEN_SECRET as string,
  ...
  clientRedirectCallback: process.env.CLIENT_REDIRECT_URI_CALLBACK as string,
